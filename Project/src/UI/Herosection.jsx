...
function Home() {
  return (
    <div className="lg:px-[110px]  px-6 flex flex-col-reverse md:flex-row items-center justify-center">
      {/* Left Section */}
      <div className="text-center md:text-left md:w-1/2">
        <h1 className="text-white text-4xl lg:text-5xl font-bold mb-6">
          <span className="bg-gradient-to-r from-red-400 via-green-500 to-purple-600 bg-clip-text text-transparent">
      ...
      <div className="md:w-1/2 flex justify-center">
        <img
          src="happypic.png"
          alt="Happy People"
          className="w-[80%] max-w-[500px] lg:w-[700px]"
        />
      </div>
    </div>
  );
